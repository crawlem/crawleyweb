...
FileModel = (function(_super) {
  ...
  FileModel.prototype.setOptions = function(opts) {
    if (opts == null) {
      opts = {};
    }
    if (opts.detectEncoding != null) {
      this.rootOutDirPath = opts.detectEncoding;
      delete opts.detectEncoding;
      delete this.attributes.detectEncoding;
    }
    if (opts.rootOutDirPath != null) {
      this.rootOutDirPath = opts.rootOutDirPath;
  ...
  FileModel.prototype.set = function(attrs, opts) {
    ...
    this.setOptions(attrs);
    return FileModel.__super__.set.call(this, attrs, opts);
  };
  ...
  FileModel.prototype.setMetaDefaults = function(attrs) {
    var _ref2;
    attrs = (_ref2 = typeof attrs.toJSON === "function" ? attrs.toJSON() : void 0) != null ? _ref2 : attrs;
    this.setOptions(attrs);
    this.getMeta().setDefaults(attrs);
    this.setDefaults(attrs);
    return this;
  };

  FileModel.prototype.setDefaults = function(attrs) {
    var _ref2;
    attrs = (_ref2 = typeof attrs.toJSON === "function" ? attrs.toJSON() : void 0) != null ? _ref2 : attrs;
    this.setOptions(attrs);
    return FileModel.__super__.setDefaults.apply(this, arguments);
  };
  ...
  FileModel.prototype.initialize = function(attrs, opts) {
    var now, _base, _base1, _base2, _base3, _base4;
    if (attrs == null) {
      attrs = {};
    }
    if (opts == null) {
    ...
    return FileModel.__super__.initialize.call(this, attrs, opts);
  };
  ...
  FileModel.prototype.normalize = function(opts, next) {
    ...
    if (!outPath) {
      changes.outPath = outPath = pathUtil.resolve(this.rootOutDirPath, relativeDirPath, outFilename);
    }
    ...
    changes.relativeOutPath = relativeOutPath = outPath.replace(this.rootOutDirPath, '').replace(/^[\/\\]/, '');
