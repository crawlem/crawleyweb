...
DocPad = (function(_super) {
  ...
  */
  ...
  DocPad.prototype.createFile = function(data, opts) {
    var docpad, file;
    if (data == null) {
      data = {};
    }
    ...
    opts = extendr.extend({
      ...
      rootOutDirPath: this.config.outPath
    }, opts);
  ...
  DocPad.prototype.createDocument = function(data, opts) {
    var docpad, document;
    if (data == null) {
      data = {};
    }
  ...
  DocPad.prototype.ensureFile = function(data, opts) {
    var database, result;
    if (data == null) {
      data = {};
    }
    ...
    if (!result) {
      result = this.createFile(data, opts);
      database.add(result);
    }
    return result;
  };

  DocPad.prototype.ensureDocument = function(data, opts) {
    var database, result;
    if (data == null) {
      data = {};
    }
    ...
    if (!result) {
      result = this.createDocument(data, opts);
      database.add(result);
    }
    return result;
  };

  DocPad.prototype.ensureFileOrDocument = function(data, opts) {
  ...
  DocPad.prototype.generateLoad = function(opts, next) {
    ...
    docpad.loadFiles({
      ...
      var addLayoutChildren, allStandalone, referencesOthersCollection;
      if (err) {
        return next(err);
      }
      allStandalone = (__indexOf.call(opts.collection.pluck('standalone'), false) < 0);
